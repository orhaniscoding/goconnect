...
const (
	...
	ActionNetworkJoin        = "NETWORK_JOIN"
	ActionNetworkJoinRequest = "NETWORK_JOIN_REQUEST"
	ActionNetworkJoinDeny    = "NETWORK_JOIN_DENY"
	ActionNetworkMemberKick  = "NETWORK_MEMBER_KICK"
