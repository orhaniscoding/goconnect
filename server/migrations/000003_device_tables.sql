...
-- Version: 000003
-- Description: Device registration and management with WireGuard support
...
CREATE TABLE IF NOT EXISTS devices (
    ...
    pubkey TEXT NOT NULL UNIQUE, -- WireGuard public key (44 chars base64)
    ...
    disabled_at TIMESTAMPTZ -- Soft disable flag
);
...
CREATE INDEX IF NOT EXISTS idx_devices_pubkey 
    ON devices(pubkey);

CREATE INDEX IF NOT EXISTS idx_devices_active 
    ON devices(active, last_seen DESC) 
