...
- [GoConnect Deployment Guide](#goconnect-deployment-guide)
  ...
  - [💻 Client Daemon Installation](#-client-daemon-installation)
    ...
    - [macOS](#macos-1)
    - [Windows](#windows-1)
  - [⚙️ Post-Installation](#️-post-installation)
    - [1. Verify Server Health](#1-verify-server-health)
    - [2. Access Web UI](#2-access-web-ui)
    - [3. Create Admin User](#3-create-admin-user)
    - [4. Configure Client](#4-configure-client)
